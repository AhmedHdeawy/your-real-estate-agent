						...
						<div class='search-con'>
							...
							<form>
								<div class='row'>
									...
									<div class='col-md-3 col-6'>
										<div class='form-group'>
											<input class='form-control' placeholder='المدينة، المنطقة أو اسم البناء' title='keyword' type='text'>
										</div>
									</div>
									<div class='col-md-3 col-6'>
										<div class='form-group'>
									...
									<div class='col-md-3 col-12'>
										<div class='row'>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='أدنى سعر' title='min price' type='text'>
												</div>
											</div>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='أعلى سعر' title='max price' type='text'>
												</div>
											</div>
										</div>
									</div>
									<div class='col-md-3 col-12'>
										<div class='row'>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='عدد الغرف الأدنى' title='min bedrooms' type='text'>
												</div>
											</div>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='عدد الغرف الأقصي' title='max bedrooms' type='text'>
												</div>
											</div>
										</div>
									</div>
									<div class='col-md-3 col-12'>
										<div class='row'>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='أقصي مساحة' title='min area' type='text'>
												</div>
											</div>
											<div class='col-6'>
												<div class='form-group'>
													<input class='form-control' inputmode='numeric' placeholder='أدنى مساحة' title='max area' type='text'>
												</div>
											</div>
										</div>
									</div>
									...
									<div class='col-md-3 col-6'>
										<div class='form-group'>
											<input class='form-control' placeholder='كلمات البحث' title='keywords' type='text'>
										</div>
									</div>
									<div class='col-md-3 col-12'>
										<button class='btn'>
