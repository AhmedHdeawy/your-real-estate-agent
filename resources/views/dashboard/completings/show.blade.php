        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="row show-details-row">
                    ...
                    <div class="col-sm-10">
                        {{ $completing->translate($showLang)->name }}
                    </div>
                </div>
            ...
            <div class="card-footer">
                <a href="{{ route('admin.completings.edit', $completing->id) }}" class="btn btn-warning">
                  Edit
                </a>

                <a href="{{ route('admin.completings.index') }}" class="btn btn-secondary">
                  {{ __('dashboard.back') }}
                </a>
            </div>
        </div>
