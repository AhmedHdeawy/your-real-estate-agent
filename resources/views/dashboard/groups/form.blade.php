...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <input type="text" id="name" name="name" class="form-control {{ $errors->first('name') ? 'is-invalid' : '' }}"
            placeholder="{{ __('dashboard.name') }}" value="{{ old('name', isset($group) ? $group->name : '') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <input type="number" id="age" name="age"
            ...
            placeholder="{{ __('dashboard.age') }}" value="{{ old('age', isset($group) ? $group->age : '') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <input type="text" id="phone" name="phone"
            ...
            placeholder="{{ __('dashboard.phone') }}" value="{{ old('phone', isset($group) ? $group->phone : '') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <input type="email" id="email" name="email"
            ...
            placeholder="{{ __('dashboard.email') }}" value="{{ old('email', isset($group) ? $group->email : '') }}">
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        ['name' => 'avatar', 'value' => isset($group) ? $group->avatar : null, 'path' => 'uploads/groups/']
        )
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        @php
        $status = old('status', isset($group) ? $group->status : 1);
        @endphp
