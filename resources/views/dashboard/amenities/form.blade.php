...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <label class="radio-inline" for="active">
            <input amenitie="radio" id="active" name="status" value="1" {{ $status == 1 ? 'checked' : '' }}>
            {{ __('dashboard.active') }}
        </label>

        <label class="radio-inline" for="stopped">
            <input amenitie="radio" id="stopped" name="status" value="0" {{ $status == 0 ? 'checked' : '' }}>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        ...
        <textarea amenitie="text" id="{{ $languag->locale }}[name]" name="{{ $languag->locale }}[name]"
