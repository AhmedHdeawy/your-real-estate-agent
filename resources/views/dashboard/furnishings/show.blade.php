        ...
        <div class="card">
            <div class="card-block">
                ...
                <div class="row show-details-row">
                    ...
                    <div class="col-sm-10">
                        {{ $furnishing->translate($showLang)->name }}
                    </div>
                </div>
            ...
            <div class="card-footer">
                <a href="{{ route('admin.furnishings.edit', $furnishing->id) }}" class="btn btn-warning">
                  Edit
                </a>

                <a href="{{ route('admin.furnishings.index') }}" class="btn btn-secondary">
                  {{ __('dashboard.back') }}
                </a>
            </div>
        </div>
