...
@section('breadcrumb')
  ...
  <li class="breadcrumb-item"><a href="{{ route('admin.types.index') }}"> {{ __('dashboard.types') }} </a></li>
...
@section('content')
  ...
  <form action="{{ route('admin.types.update', $type->id) }}" method="post" class="form-horizontal " enctype="multipart/form-data">
    @method('PUT')
    @csrf
